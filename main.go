...
func printHelp() {
	...
	fmt.Printf("      --random-tls         rotate browser TLS fingerprints per request (default: fixed Chrome)\n")
	fmt.Printf("      --no-random-tls      legacy compat: fixed Chrome is the default now\n")
